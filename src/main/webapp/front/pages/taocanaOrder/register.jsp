              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">预定数量:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="orderNumber" id="orderNumber"  lay-verify="integer|required"   placeholder="预定数量" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
