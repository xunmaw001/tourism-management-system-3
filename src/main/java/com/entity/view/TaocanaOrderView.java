...
public class TaocanaOrderView extends TaocanaOrderEntity implements Serializable {
	...
	public TaocanaOrderView() {

	}

	public TaocanaOrderView(TaocanaOrderEntity taocanaOrderEntity) {
		try {
			BeanUtils.copyProperties(this, taocanaOrderEntity);
