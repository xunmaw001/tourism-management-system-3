...
public class TaocanaLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public TaocanaLiuyanEntity() {

	}

	public TaocanaLiuyanEntity(T t) {
		try {
     ...
     * 留言内容
     */
    @TableField(value = "taocana_liuyan_content")
    ...
    public String toString() {
        return "TaocanaLiuyan{" +
            "id=" + id +
            ", taocanaId=" + taocanaId +
            ", yonghuId=" + yonghuId +
            ", taocanaLiuyanContent=" + taocanaLiuyanContent +
